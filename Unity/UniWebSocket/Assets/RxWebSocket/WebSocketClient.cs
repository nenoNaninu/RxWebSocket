...
namespace RxWebSocket
{
    public partial class WebSocketClient : IWebSocketClient
    {
        ...
        private readonly Channel<SendMessage> _sendMessageQueue;
        private readonly ChannelReader<SendMessage> _sendMessageQueueReader;
        private readonly ChannelWriter<SendMessage> _sendMessageQueueWriter;
        ...
        /// <param name="sendMessageQueue"></param>
        public WebSocketClient(WebSocket connectedSocket, ILogger logger = null, Channel<SendMessage> sendMessageQueue = null)
        {
            Url = null;
