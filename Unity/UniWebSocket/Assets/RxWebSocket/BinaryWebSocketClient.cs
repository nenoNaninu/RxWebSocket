...
namespace RxWebSocket
{
    public partial class BinaryWebSocketClient : IWebSocketClient
    {
        ...
        private readonly BlockingCollection<ArraySegment<byte>> _binaryMessageQueue = new BlockingCollection<ArraySegment<byte>>();
        ...
        public int QueueCount => _binaryMessageQueue.Count;
